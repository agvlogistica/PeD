<div class="modal inmodal" id="vinculo_modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
    <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                <h4 class="modal-title">Vínculo</h4>
            ...
            <div class="modal-body" style="padding-bottom: 0px;">
                <table id="lista_vinculo_table" class="table table-striped table-condensed" style="font-size: 11px;">
                    <thead>
                        <tr>
                            <th>Origem</th>
                            <th>Destino</th>
